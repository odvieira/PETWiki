---
    title: PET Mais Saúde
    description: grupo da Universidade Federal de Uberlândia
    published: true
    date: 2023-11-29 00:58:48.453583
    tags: Interdisciplinar, Conexões do Saberes: Populações do Campo
    editor: markdown
    dateCreated: 2023-11-29 00:58:48.453583
    ---

   # PET Mais Saúde


    | ![placeholder.png](/placeholder.png) | UFUâ         |
    | ------------------------------------ | --------------------------------- |
    ...
    | Temática                             | Conexões do Saberes: Populações do Campo          |
    | Ano de criação                       | 2010        |
