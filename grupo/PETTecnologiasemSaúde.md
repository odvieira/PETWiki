---
    title: PET Tecnologias em Saúde
    description: grupo da Universidade Federal de São Paulo
    published: true
    date: 2023-11-29 00:58:48.443585
    tags: Interdisciplinar, Estudo das Ciências Exatas aplicadas ao corpo humano
    editor: markdown
    dateCreated: 2023-11-29 00:58:48.443585
    ---

   # PET Tecnologias em Saúde


    | ![placeholder.png](/placeholder.png) | UFSãP         |
    | ------------------------------------ | --------------------------------- |
    ...
    | Temática                             | Estudo das Ciências Exatas aplicadas ao corpo humano          |
    | Ano de criação                       | 2013        |
